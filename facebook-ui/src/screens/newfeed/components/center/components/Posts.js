          ...
          <div className="content_post" style={{width: '93%'}}>
            ...
            <div className="post_like">
              ...
              <div className="comment_user">
                ...
                >
                  {countComments(this.props.comments, post.id)} bình luận
                </p>
              </div>
            </div>
            ...
            <div className="comments_post">
              {this.props.comments
                .filter(
                  (comment_parent) =>
                    comment_parent.post_id == post.id &&
                    ...
                    {this.state.replyField && (
                      <div className={"reply_field_" + comment_parent.id}>
                        ...
                        <form onSubmit={this.modifyTask}>
                          <input
                            onChange={(e) =>
                              this.commentChild(e, post.id, comment_parent.id)
                            }
                            type="text"
                            placeholder="Trả lời....."
                            style={{
              ...
              <form onSubmit={this.modifyTask}>
                <input
                  onChange={(e) => this.handleChange(e, post.id)}
                  type="text"
